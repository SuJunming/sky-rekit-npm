...
const xxaxasxaxaxaASXAADAD1: React.FC = (props: any) => {
  ...
  const { list } = props.xxaxasxaxaxaASXAADAD1;
  const { total, page } = list;

  return (
<div className='xxaxasxaxaxa-a-s-x-a-a-d-a-d1-page'>
    <PageWrapper title="xxaxasxaxaxaASXAADAD1">
...
export default C({
    modal: 'xxaxasxaxaxaASXAADAD1',
    Component: xxaxasxaxaxaASXAADAD1,
    title: 'xxaxasxaxaxaASXAADAD1'
})
